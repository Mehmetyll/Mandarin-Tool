...
🇺🇸 [English](FAQ-And-Troubleshooting) · **🇹🇷 Türkçe**

**S: Hangi Java sürümünü kullanmalıyım?**
Java 21 veya üzeri.

**S: Bazı modüller neden boş sonuç gösteriyor?**
Muhtemelen Yönetici olarak çalıştırmıyorsunuz (veya cidden sonuç yok). CMD'yi sağ tık → Yönetici olarak çalıştır → `java -jar MandarinTool.jar`
